export const allNewsData = [
  {
    ...
    description: "Analisis mendalam mengenai bagaimana institusi pendidikan dan kebudayaan beradaptasi dengan kecepatan algoritma tanpa kehilangan esensi tradisi.",
    ...
    authorImage: "https://picsum.photos/seed/user1/40/40",
    readTime: "5 min read",
    reactions: { clap: 142, light: 86, idea: 54 }
  },
  {
    id: "2",
    date: "10 MEI 2026",
    ...
    readTime: "3 min read",
    reactions: { clap: 50, light: 20, idea: 15 }
  },
  {
    id: "3",
    date: "08 OKT 2025",
  ...
  },
  {
    ...
    date: "09 OKT 2025",
    category: "TECHNOLOGY",
    title: "Etika Kecerdasan Buatan dalam Kehidupan Sehari-hari",
  ...
  },
  {
    ...
    date: "10 OKT 2025",
    category: "SOCIAL",
    title: "Seni Hidup Lambat di Tengah Kecepatan Metropolitan",
  ...
  },
  {
    ...
    date: "11 OKT 2025",
    category: "DESIGN",
    title: "Etika Materialitas: Masa Depan Komponen Mewah",
    description: "Menelusuri asal-usul komponen mewah dan tuntutan konsumen terhadap transparansi yang lebih radikal.",
    excerpt: "Kenapa brand global mulai beralih ke material daur ulang untuk produk high-end mereka.",
    author: "Andi Pratama",
  ...
  },
  {
    ...
    date: "12 OKT 2025",
    category: "EDUCATION",
    title: "Terobosan Genetik dalam Mitigasi Penyakit Tropis",
    description: "Inovasi medis terbaru yang memanfaatkan teknologi CRISPR.",
    excerpt: "Harapan baru bagi pemberantasan penyakit endemik di wilayah tropis melalui rekayasa genetika.",
    author: "Dr. Hani",
...
// Data Sidebar & Komentar (Tetap dipisah karena tipenya beda)
export const dummyComments = [
  { id: 1, author: "Fahri Sani", time: "2 hours ago", text: "Harusnya Lebih Dilestarikan dong bukan dijual gini gimana sih pemerintah" },
  { id: 2, author: "Vennanda", time: "2 hours ago", text: "Gak setuju am komen atas gw, kita butuh 1000rb lapangan pekerjaan" }
];
...
export const moreData = [
  { id: "8", title: "Regenerasi Agrikultur: Apakah Bisa?", date: "12 JANUARI 2026", img: "https://picsum.photos/seed/agri1/60/60" },
  { id: "9", title: "Tanam Ubi Di Pasir Untung Jutaan Rupiah", date: "10 JANUARI 2026", img: "https://picsum.photos/seed/ubi2/60/60" }
];